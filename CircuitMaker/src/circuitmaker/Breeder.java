...
public class Breeder {
    ...
    Circuit[] breed(short populationSize, Circuit[] currentPopulation)
    {
    ...
    static String pickUpConnection(byte s, int i, int g){
        int h;
        String id = "";
    ...
    void grade(Circuit[] currentPopulation, int inputListNumber)
    {
        ...
        {
            currentPopulation[c].findPDelay();
...
//                    2 * currentPopulation[c].propagationDelay;
            ...
            currentPopulation[c].fitness -= 1 * 
                    Math.abs(desiredOutputsListing[inputListNumber].length - 
                    currentPopulation[c].outputListListing[inputListNumber].length);
        }
    }
    
    void selection(Circuit[] currentPopulation)
    {
...
//        }
    ...
    Circuit[] insertionSort(Circuit[] circuitz){
        Circuit item;
        int hole;
